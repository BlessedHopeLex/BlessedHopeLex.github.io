...
{% include bootstrap-alert-primary.md content="The link will open a website, and you will be asked to download the Zoom app (available on Windows, Mac, Iphone, and Android).
